...
// Create Table
$jdb->create_table($table_name);

// Add row to table
if($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['column-name'])){
  $jdb->delete_column($table_name, $_POST['column-name']);
}
...
<body id="page-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-12">
          ...
          <h3>Explanations</h3>
          <p>This code is the explanation for deleting existing column</p>
  ...
  <section id="contact">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-5">JDB Add DB Form</h2>
      <div class="row">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-5 pb-2">
                ...
                <input class="form-control" name="column-name" id="name" type="text" placeholder="Column Name" required="required"
                  data-validation-required-message="Please enter name of the Column you want to delete.">
