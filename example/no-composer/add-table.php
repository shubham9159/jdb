...
if($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['table-name'])){
  $jdb->create_table($_POST['table-name']);
}
...
<body id="page-top">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-12">
          ...
          <h3>Explanations</h3>
          <p>This code is the explanation for adding new table</p>

          <h3 class="mt-5">Code</h3>
          <p>This code illustrates - how to add data into table row.</p>
          <?php include __DIR__.'/codes/add-table-code.php'; ?>
  ...
  <section id="contact">
    <div class="container">
      <h2 class="text-center text-uppercase text-secondary mb-5">Add Table Form</h2>
      <div class="row">
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls mb-5 pb-2">
                ...
                <input class="form-control" name="table-name" id="name" type="text" placeholder="table Name" required="required"
                  data-validation-required-message="Please enter name of the table you want to add.">
